...
Perform the second independent normal analysis path for the assigned security. Use the supplied research
context, frozen evidence set, market profile, source policy, and detailed-analysis policy without seeking
the Codex worker's conclusion.
